...
def image_masking():
 ...
 with col1:
    ...
    if uploaded_image_file:
        ...
        st.image("./image_masking/images/desk1.jpg")
 ...
 with col2:
    ...
    if masking_mode == 'Image':
        ...
        if uploaded_mask_file:
            ...
            st.image("./image_masking/images/mask1.png")
    else:
    ...
    if generate_button:
        with st.spinner("Drawing..."):
            ...
            if uploaded_image_file:
                ...
                image_bytes = glib.get_bytes_from_file("./image_masking/images/desk1.jpg")
            
            if masking_mode == 'Image':
                if uploaded_mask_file:
                    mask_bytes = uploaded_mask_file.getvalue()
                else:
                    mask_bytes = glib.get_bytes_from_file("./image_masking/images/mask1.png")
